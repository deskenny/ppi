...
public class TestUriMatcher extends AndroidTestCase {
    ...
    private static final Uri TEST_WEATHER_WITH_LOCATION_DIR = PropertyContract.PropertyEntry.buildWeatherLocation(LOCATION_QUERY);
    private static final Uri TEST_WEATHER_WITH_LOCATION_AND_ADDRESS_DIR = PropertyContract.PropertyEntry.buildWeatherLocationWithAddress(LOCATION_QUERY, TEST_ADDRESS);
