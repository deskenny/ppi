...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        rVal.addURI(authority, WeatherContract.PATH_WEATHER, WEATHER);
        rVal.addURI(authority, WeatherContract.PATH_WEATHER + "/*", WEATHER_WITH_LOCATION);
        rVal.addURI(authority, WeatherContract.PATH_WEATHER+ "/*/#", WEATHER_WITH_LOCATION_AND_DATE);
        rVal.addURI(authority, WeatherContract.PATH_LOCATION, LOCATION);
