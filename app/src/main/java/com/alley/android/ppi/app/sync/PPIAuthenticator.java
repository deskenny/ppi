...
/**
 * Manages "Authentication" to PPI's backend service.  The SyncAdapter framework
 ...
 */
public class PPIAuthenticator extends AbstractAccountAuthenticator {

    public PPIAuthenticator(Context context) {
        super(context);
    }
